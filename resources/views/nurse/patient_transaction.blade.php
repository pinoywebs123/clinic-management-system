    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
          <div class="row">
            ...
            <h3 class="text-center">Admission History</h3>
            <table class="table">
              <thead>
                <tr>
                  <th>Pulse</th>
              ...
              <tbody>
               ...
               <tr>
                 <td>{{$morls->pulse}}</td>
                 <td>{{$morls->blood_pressure}}</td>
                 <td>{{$morls->respiration}}</td>
                 <td>{{$morls->temperature}}</td>
                 <td>{{$morls->cause_admission}}</td>
